...
import random
import copy
from src.utils.generic_utils import timer
from src.utils.generic_utils import get_new_id
...
def allotables_generator(parsed_data,university_id:str=None, division_id:str=None):
    if division_id is not None:
        pass
    elif university_id is not None:
        pass
    else:
        raise Exception("No scope input to geenrate slots")
