import json
from src_v2.data_validation import validate_stage_1
from src_v2.business_validation import validate_stage_2
from src_v2.transformer import transform
if __name__ == "src.app":
    ...
    with open("./data/inputs/input_1.json","r") as input_data:
        ...
        from src_v2.utils.generic_utils import save_output_file
